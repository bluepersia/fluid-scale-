...
var FluidScale = (() => {
  ...
  function assertShorthandExpanded(prop, resultStyle, masterRule) {
  ...
  var cloneFluidPropAssertionChain = {
    "should clone the fluid prop": (state, args, result) => withEventNames(
      args,
      [
        "fluidPropCloned",
        "shorthandExpanded",
